...
// const { generateText } = require("../utils/openai"); // your existing OpenAI util
...
// 4. Return output in strict JSON format like this:
...
// - Options are reasonably shuffled.
// `;
...
//       return res.status(500).json({ error: "Failed to parse AI response as JSON", aiResponse });
//     }
